...
<head>
    ...
    <section class="hero-section" style="background-image: url('<?php echo !empty($site['product_hero_banner_img']) ? htmlspecialchars($site['product_hero_banner_img']) : 'assets/img/product-slider.webp'; ?>');"
        ...
        <div class="hero-content">
           <h1 translate="no" class="product2-title notranslate"><?php echo htmlspecialchars($site['name'], ENT_QUOTES, 'UTF-8'); ?><?php if ($site['sub_name'] !== ''): ?><sup class="<?php echo htmlspecialchars($superScriptClass, ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($site['sub_name'], ENT_QUOTES,'UTF-8'); ?></sup><?php endif; ?></h1>
